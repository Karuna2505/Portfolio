...
function Project({title,image,description,github,link}) {
  return (
    <div className='h-auto m-4 rounded-2xl '>
      ...
      <div className='flex'>
      <a href={github}><img src="/github.png" alt="Github Link" className='h-7 w-7 mt-5 mx-2'/></a>
      <a href={link}><img src="/sitelink.png" alt="Direct Link" className='h-7 w-7 mt-5'/></a>
      </div>
      </div>
